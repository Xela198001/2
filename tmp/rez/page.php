<?php 
if (isset($_GET['page']))      {$page = $_GET['page']; $page =htmlspecialchars($page); if ($page == '') {unset($page);}}
include ("blocks/bd.php"); /*Соединяемся с базой*/
$result = mysql_query("SELECT title,meta_d,meta_k,text FROM settings WHERE page='$page'",$db);
...
<div id="center"> 
<div class="center_header"><h1 class="header"><? echo $myrow['title']; ?></div> 
<div class="scroll">
        <?php echo $myrow['text']; ?>
